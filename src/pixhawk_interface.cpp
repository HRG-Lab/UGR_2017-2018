...
PixhawkInterface::PixhawkInterface(std::string port_name, int baudrate) {
    std::cerr << "PixhawkInterface(" << port_name << ", "
                           << baudrate << ")";
...
std::string PixhawkInterface::read_thread() {
  ...
  std::cerr << "sysid: " << (int)message.sysid
                           << " compid: " << (int)message.compid;
...
void PixhawkInterface::close() {
    std::cerr << "Unhandled Message IDs: ";
...
std::string PixhawkInterface::decode_message(const mavlink_message_t &message) {
  ...
  case MAVLINK_MSG_ID_HEARTBEAT: {
      std::cerr << "MAVLINK_MSG_ID_HEARTBEAT";
    mavlink_heartbeat_t heartbeat;
    mavlink_msg_heartbeat_decode(&message, &heartbeat);
    break;
  }
  case MAVLINK_MSG_ID_LOCAL_POSITION_NED: {
      std::cerr << "MAVLINK_MSG_ID_LOCAL_POSITION_NED";
    break;
  }
  case MAVLINK_MSG_ID_GLOBAL_POSITION_INT: {
      std::cerr << "MAVLINK_MSG_GLOBAL_POSITION_INT";
  ...
  case MAVLINK_MSG_ID_ATTITUDE: {
      std::cerr << "MAVLINK_MSG_ID_ATTITUDE";
