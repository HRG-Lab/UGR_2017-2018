...
def uv_matrix():
  ...
  KK = np.array([[529.21508098293293, 0, 328.94272028759258, 0],
                 [0, 525.56393630057437, 267.48068171871557, 0],
                 [0, 0, 0, 1],
                 [0, 0, 1, 0]])
  m = np.dot(KK, (m))
  return m
...
def xyz_matrix():
  ...
  a = -0.0030711016 #parameter given by kinect for 11-bit to meters
  b = 3.3309495161 #parameter given by kinect for 11-bit to meters
  cx = 339.0780975300314
